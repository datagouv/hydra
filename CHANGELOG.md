...
- Fix and add new purge tables CLI utils [#271](https://github.com/datagouv/hydra/pull/271)
- Rename CLI arguments in line with existing one [#272](https://github.com/datagouv/hydra/pull/272)
