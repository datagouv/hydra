...
from udata_hydra.crawl.utils_http import get_content_type_from_header, is_valid_status
...
async def process_check_data(check_data: dict) -> Tuple[int, bool]:
    ...
    last_check: Optional[dict] = await Check.get_by_resource_id(check_data["resource_id"])
